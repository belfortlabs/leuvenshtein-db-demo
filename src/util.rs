...
// use crate::levenshtein::lut;
// use crate::levenshtein::{self, data, plain_impl::levenshtein_plain};
...
//                 eq1_lut = eq1.clone();
//                 fpga.keyswitch_bootstrap_packed(&mut eq1_lut, &lut_eq1_fpga_indexes);
//                 // }
...
//                 eq2_lut = eq2.clone();
//                 fpga.keyswitch_bootstrap_packed(&mut eq2_lut, &lut_eq2_fpga_indexes);
//                 // }
...
//                 ct_res = key.clone();
//                 fpga.keyswitch_bootstrap_packed(&mut ct_res, &lut_min_fpga_indexes);
//                 // }
